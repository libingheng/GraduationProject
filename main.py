...
parser.add_argument('--model_name',
                    default='m3fend')  # textcnn bigru bert eann eddfn mmoe mose dualemotion stylelstm mdfend
...
# conda activate D:\Anaconda\envs\m3
...
print('lr: {}; model name: {}; batchsize: {}; epoch: {}; gpu: {}; domain_num: {}'.format(args.lr, args.model_name,
                                                                                         args.batchsize, args.epoch,
                                                                                         args.gpu, args.domain_num))
